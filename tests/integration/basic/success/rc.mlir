...
module @test {
  ...
  func.func private @foo() -> !reussir.rc<index unspecified normal>

  // CHECK: func.func private @bar() -> !reussir.rc<index rigid>
  func.func private @bar() -> !reussir.rc<index rigid normal>

  // CHECK: func.func private @baz() -> !reussir.rc<index shared atomic>
  func.func private @baz() -> !reussir.rc<index shared atomic>

  // CHECK: func.func private @qux() -> !reussir.rc<index shared atomic>
